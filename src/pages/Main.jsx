...

  {
    data.map((item,i)=>(
        ...
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-[400px] w-[380px] hover:scale-95 hover:border-spacing-3 hover:rounded-md hover:dark:bg-slate-700 hover:cursor-pointer" key={i}>
          ...
          <FaLanguage className="text-white" size={'30px'}/><p className="font-normal text-lg text-gray-700 dark:text-gray-400">{item?.original_language}</p> 
          </div>
          ...
          {/* <div className="p-3 flex justify-start gap-2 items-center">
          <div className="flex justify-start items-center gap-2">
          <HiTrendingUp className="text-white" size={'30px'}/><p className="font-normal text-lg text-gray-700 dark:text-gray-400">{item?.popularity}</p> 
          </div>
          </div> */}

          {/* <div className="p-3 flex justify-start gap-2 items-center">
          <div className="flex justify-start items-center gap-2">
          <MdDateRange className="text-white" size={'30px'}/><p className="font-normal text-lg text-gray-700 dark:text-gray-400">{item?.release_date}</p> 
          </div>
          </div> */}
