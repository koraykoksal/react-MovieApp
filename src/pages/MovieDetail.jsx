...
const MovieDetail = () => {
  ...
  //! movieCard sayfasından link ile gönderilen ID bilgisi burada useParams ile yalanır.
  const {id} = useParams()
  ...
  //* sayfa render olduğunda ve ID bilgisi true ise useEffect çalışacak
  useEffect(() => {
        ...
        <div className="p-6 flex flex-col justify-between">
          ...
          <ul className="bg-gray-100 rounded-lg border border-gray-400 text-gray-900">
            ...
            <li className="px-6 py-2 border-gray-400 w-full rounded-t-lg">
              <Link
                to={-1}
                className="text-blue-600 underline-offset-1 hover:text-blue-700 transition duration-300 ease-in-out mb-4"
              >
                Go Back
              </Link>
            </li>
